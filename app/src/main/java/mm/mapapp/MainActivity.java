...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opis = "dodaj opis";
        nameTV.setHint(nazwa);
        descTV.setHint(opis);
        adressTV = (TextView) findViewById(R.id.adressTV);
        adressTV.setVisibility(View.INVISIBLE); //ukrylem ten textViev bo w poleceniu jest mowa tylko o 2text view, a ten moze mi sie przydac w przyszlosci
